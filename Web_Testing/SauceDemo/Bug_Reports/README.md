...
![Cart retains previous user's item after logout](Screenshots/01_cart_persists_across_users.png.png)
...
![All products showing the same image](Screenshots/02_problem_user_duplicate_images.png.png)
